    ...
    return (
        <div className='shadow-lg relative rounded-3xl border p-3 flex flex-col text-indigo-900'>
            ...
            <div className='flex gap-2 mt-5'>
                ...
                {
                    pathname.includes("cart") &&
                    (<button title='Remove' onClick={() => dispatch({ type: REMOVE_FROM_CART, payload: product })} className='flex justify-between px-3 bg-red-500 text-white p-1 rounded-full flex-1'>
                        <p>Remove</p>
